        ...
        stage("ANALISE SONARQUBE"){
            ...
            steps{
                withSonarQubeEnv('SONAR_LOCAL'){
                    sh "${scannerHome}/bin/sonar-scanner -e -Dsonar.projectKey=TodoBackend -Dsonar.cs.opencover.reportsPaths=src/todobackend.Tests/coverage.opencover.xml -Dsonar.coverage.exclusions=**Test*.cs -Dsonar.host.url=http://sonarqube_dev:9000 -Dsonar.login=0c09bbe076dfe2f87d40fd4ccc5350818b99b9f0"
                }
